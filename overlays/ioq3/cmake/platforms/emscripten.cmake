...
# Enable WebSocket support and asyncify for cooperative sleeps in NET_Sleep
list(APPEND CLIENT_LINK_OPTIONS -sASYNCIFY)

option(EMSCRIPTEN_PRELOAD_FILE "Preload game files into .data file" OFF)
set(EMSCRIPTEN_PRELOAD_DIR "${BASEGAME}" CACHE STRING "Game directory to preload into the Emscripten data file")

if(EMSCRIPTEN_PRELOAD_FILE)
    if(NOT EXISTS "${CMAKE_SOURCE_DIR}/${EMSCRIPTEN_PRELOAD_DIR}")
        message(FATAL_ERROR "No files in '${EMSCRIPTEN_PRELOAD_DIR}' directory for emscripten to preload.")
    endif()
    list(APPEND CLIENT_LINK_OPTIONS --preload-file "${EMSCRIPTEN_PRELOAD_DIR}")
endif()
